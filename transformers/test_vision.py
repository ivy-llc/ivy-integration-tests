...
def test_Swin2SR(target_framework, mode, backend_compile):
    ...
    translated_model = TFSwin2SRModel.from_pretrained(
    ...
    # TODO: remove this once from_pretrained is working properly
    os.environ["USE_NATIVE_KERAS_LAYERS"] = "true"
    os.environ["APPLY_TRANSPOSE_OPTIMIZATION"] = "true"
    _sync_models_HF_torch_to_tf(torch_model, translated_model)
