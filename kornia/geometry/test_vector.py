...
def test_Vector3(target_framework, mode, backend_compile):
    ...
    transpiled_vector3_from_coords = transpiled_kornia.geometry.vector.Vector3.from_coords(1.0, 2.0, 3.0)
...
def test_Vector2(target_framework, mode, backend_compile):
    ...
    transpiled_vector2_from_coords = transpiled_kornia.geometry.vector.Vector2.from_coords(1.0, 2.0)
