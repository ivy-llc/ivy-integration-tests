...
def test_So3(target_framework, mode, backend_compile):
    ...
    transpiled_other_quaternion_obj = ivy.transpile(kornia.geometry.quaternion.Quaternion, source="torch", target=target_framework)(transpiled_other_quaternion)
    transpiled_other_so3 = TranspiledSo3(transpiled_other_quaternion_obj)
    ...
    transpiled_from_matrix = TranspiledSo3.from_matrix(transpiled_rotation_matrix)
    ...
    transpiled_exp = TranspiledSo3.exp(transpiled_exp_vector)
...
def test_Se3(target_framework, mode, backend_compile):
    ...
    transpiled_other_quaternion_obj = ivy.transpile(kornia.geometry.quaternion.Quaternion, source="torch", target=target_framework)(transpiled_other_quaternion)
    transpiled_other_se3 = TranspiledSe3(transpiled_other_quaternion_obj, transpiled_other_translation)
    ...
    transpiled_from_matrix = TranspiledSe3.from_matrix(transpiled_rotation_translation_matrix)
    ...
    transpiled_exp = TranspiledSe3.exp(transpiled_exp_vector)
...
def test_So2(target_framework, mode, backend_compile):
    ...
    transpiled_from_matrix = TranspiledSo2.from_matrix(transpiled_rotation_matrix)
    ...
    transpiled_hat = TranspiledSo2.hat(transpiled_hat_theta)
    _to_numpy_and_allclose(torch_hat, transpiled_hat)

    torch_vee = kornia.geometry.liegroup.So2.vee(torch_hat)
    transpiled_vee = TranspiledSo2.vee(transpiled_hat)
...
def test_Se2(target_framework, mode, backend_compile):
    ...
    transpiled_hat = TranspiledSe2.hat(transpiled_hat_v)
    _to_numpy_and_allclose(torch_hat, transpiled_hat)

    torch_vee = kornia.geometry.liegroup.Se2.vee(torch_hat)
    transpiled_vee = TranspiledSe2.vee(transpiled_hat)
    _to_numpy_and_allclose(torch_vee, transpiled_vee)
    ...
    transpiled_trans_se2 = TranspiledSe2.trans(transpiled_x_translation, transpiled_y_translation)
    ...
    transpiled_trans_x_se2 = TranspiledSe2.trans_x(transpiled_x_translation)
    ...
    transpiled_trans_y_se2 = TranspiledSe2.trans_y(transpiled_y_translation)
